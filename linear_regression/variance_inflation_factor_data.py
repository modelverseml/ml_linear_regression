...
VIF measures how much the variance of a regression coefficient is inflated by
linear dependence with the other features. For feature X_j,

    VIF_j = 1 / (1 - R_j^2)

where R_j^2 is the R-squared of regressing X_j on all the other features.
...
class VIF:
    ...
    def get_vif_values(self):
        """Return a DataFrame of (feature, VIF) pairs sorted by VIF descending."""
