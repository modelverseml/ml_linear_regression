...
Thin wrapper around scikit-learn's RFE. Starting from the full feature set, RFE
fits the estimator, ranks features by their absolute coefficient, drops the
weakest, and repeats until only number_of_features remain. Use it when you want
a fixed number of features ranked by their contribution to a linear model.
"""
