...
Fits the same model as scikit-learn's LinearRegression, but statsmodels also
exposes the per-coefficient standard errors, t-statistics, p-values and the
overall F-statistic. Those p-values are what the backward feature selection in
automated_feature_selection.py relies on.
"""
...
class SMRegressionModel:
    ...
    def summary(self):
        """Full OLS summary table with std errors, t/p-values, R-squared, F-stat."""
